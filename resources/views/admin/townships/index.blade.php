    ...
    <div class="page-title-box">
      <div class="page-title-right">
        <ol class="breadcrumb m-0">
          ...
          <li class="breadcrumb-item"><a href="{{ route('zone.admin.district.index', $townships[0]->district->province_id )}}">Quận/huyện</a></li>
        ...
        <form>
          <div class="row">
            <div class="col-2 form-inline">
              <a id="demo-btn-addrow" class="btn btn-primary" href="{{ route('zone.admin.township.create', request()->id) }}"><i class="mdi mdi-plus-circle mr-2"></i> Add New Item</a>
            </div>
            <div class="col-4">
